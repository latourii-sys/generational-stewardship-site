      ...
      <section id="member-login" className="border-y border-yellow-500/10 bg-gradient-to-b from-neutral-950 to-black px-6 py-24">
        <div className="mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <h2 className="font-serif text-4xl font-bold md:text-6xl">Login to continue your lessons.</h2>
            <p className="mt-6 text-lg leading-relaxed text-neutral-300">
              Members can access course lessons, weekly assignments, downloadable worksheets, and private training resources from one simple dashboard.
            </p>

            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              <div className="rounded-2xl border border-neutral-800 bg-black/50 p-5">
                <p className="font-bold text-yellow-400">Course Library</p>
                <p className="mt-2 text-sm text-neutral-400">Access Biblical Wealth, Stocks, Options, and Futures lessons.</p>
              </div>
              <div className="rounded-2xl border border-neutral-800 bg-black/50 p-5">
                <p className="font-bold text-yellow-400">Member Resources</p>
                <p className="mt-2 text-sm text-neutral-400">Download worksheets, journals, checklists, and study guides.</p>
              </div>
            </div>
          </div>

          <div className="rounded-[2rem] border border-yellow-500/30 bg-black p-8 shadow-2xl shadow-yellow-950/20">
            ...
            <div className="mt-8 grid gap-4">
              <div className="rounded-2xl border border-neutral-800 bg-neutral-950 p-5">
                <p className="font-bold text-white">Next Lesson</p>
                <p className="mt-2 text-sm text-neutral-400">Module 1 — Kingdom Stewardship</p>
              </div>
              <div className="rounded-2xl border border-neutral-800 bg-neutral-950 p-5">
                ...
                <p className="mt-2 text-sm text-neutral-400">25% complete</p>
              </div>
            </div>
          </div>
        </div>
